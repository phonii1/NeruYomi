...
/**
 * Resolves the running app version from the Tauri backend so it always
 * matches Cargo.toml rather than the hardcoded fallback above.
 * Returns the hardcoded fallback in browser dev mode or if the invoke fails.
 */
