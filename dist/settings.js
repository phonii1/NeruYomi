    ...
    modal.innerHTML = `
      <div class="modal-box" style="max-width:420px;max-height:85vh">
        <div class="modal-head" style="display:flex;align-items:center;justify-content:space-between">
          ...
          <button class="nav-icon-btn" onclick="$('font-pick-modal').classList.remove('open')" style="color:var(--text-muted)">${ICON.dots}</button>
        </div>
        <div class="modal-search-row">
          ...
          <button class="btn" style="font-size:10px;padding:4px 10px" onclick="_fontPickFromFile()">FROM FILE</button>
        </div>
